...
export const comicsMock : IComicResponse = {
  code: 200,
  message: "ok" ,
  status: "ok",
  copyright: "",
    ...
    results: [
      {
        ...
        urls: [
          {
            type: "detail",
            url: "http://marvel.com/comics/issue/82967/marvel_previews_2017?utm_campaign=apiRef&utm_source=662333d5497fe16ed4dc4e9fcf8fc517",
          },
        ],
        series: {
